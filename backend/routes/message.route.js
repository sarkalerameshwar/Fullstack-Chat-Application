...
import { getUsersForSidebar, getMessage, markMessagesAsRead, sendMessage } from "../controllers/message.controller.js";
...
router.post("/:id/read", protectRoute, chatMiddleware, markMessagesAsRead);
